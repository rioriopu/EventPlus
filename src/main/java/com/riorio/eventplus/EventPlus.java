...
public class EventPlus
{
  ...
  public static final int guiUltimateCraftingTable2 = 1;
  ...
  public void preInit(FMLPreInitializationEvent event)
  {
    ...
    UltimateCraftingTable = new BlockEnchantBase().setBlockName("UltimateCraftingTable").setBlockTextureName("eventplus:UltimateCraftingTable").setCreativeTab(EventPlusTab);
