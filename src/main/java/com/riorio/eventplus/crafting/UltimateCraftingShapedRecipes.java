...
public class UltimateCraftingShapedRecipes implements IRecipe
{
    ...
    public UltimateCraftingShapedRecipes(int par1, int par2, ItemStack[] par3ArrayOfItemStack, ItemStack par4ItemStack)
    {
    ...
    public UltimateCraftingShapedRecipes func_92100_c()
    {
